...
from habits_app.views import HabitCreateAPIView, HabitListAPIView, HabitRetrieveAPIView, HabitUpdateAPIView, \
...
urlpatterns = [
    ...
    path('list/publish/', HabitPublishListAPIView.as_view(), name='publish_list_habit'),

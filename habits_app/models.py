...
class Habit(models.Model):
    ...
    pleasant_habit = models.ForeignKey(to='self', on_delete=models.CASCADE,  **NULLABLE, related_name='pleasant_set')
    ...
    time_required = models.PositiveSmallIntegerField(_("time_required"), default=5)
